...
import 'package:uberr/screens/Rider/Authentication/Authentication_page.dart';
      ...
      body: Form(
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              Padding(
                padding: const EdgeInsets.only(top: 80.0, left: 80, right: 80),
                child: Text(
                  'Welcome',
              ...
              Padding(
                padding: const EdgeInsets.only(
                    left: 75, right: 50, top: 5, bottom: 60),
                child: Text(
